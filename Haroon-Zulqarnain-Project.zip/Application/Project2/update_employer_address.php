...
if (isset($_POST['field_submit'])) {
    ...
    $var_employer_address= $_POST['field_employer_address'];
    // Save the query into variable called $query. Note that :director is a place holder
    $query= "UPDATE Mega_Table SET employer_address=:employer_address WHERE case_number=:applicant;" 
   . "CALL update_employer_address(:applicant,:employer_address)";
...
try
    {
      ...
      $prepared_stmt->bindValue(':employer_address', $var_employer_address, PDO::PARAM_STR);
...
<!-- Everything inside the BODY tags are visible on page.-->
  <body>
    ...
    <h1> Update Applicant's Employer Address</h1>
    ...
    <form method="post">
      ...
      <label for="id_employer_address">New Employer Address</label>
      <input type="text" name="field_employer_address" id = "id_employer_address">
    ...
    <?php
      if (isset($_POST['f_submit'])) {
        if ($result) { 
    ?>
          Employer Address  was updated successfully. 
    <?php 
        } else { 
    ?>
