...
if (isset($_POST['field_submit'])) {
    ...
    $var_decision_date= $_POST['field_decision_date'];
    // Save the query into variable called $query. Note that :director is a place holder
    $query= "UPDATE Mega_Table SET decision_date=:decision_date WHERE case_number=:applicant;" 
    ."Call update_decision_date(:applicant,:decision_date)";
...
try
    {
      ...
      $prepared_stmt->bindValue(':decision_date', $var_decision_date, PDO::PARAM_STR);
...
<!-- Everything inside the BODY tags are visible on page.-->
  <body>
    ...
    <h1> Update Applicant's  Decision Date</h1>
    <!-- This is the decision of the form. This form has one text field and one button.
    ...
    <form method="post">
      ...
      <label for="id_decision_date">New Decision Date</label>
      <input type="text" name="field_decision_date" id = "id_decision_date">
    ...
    ?>
          Decision Date was updated successfully. 
    <?php 
        } else { 
    ?>
