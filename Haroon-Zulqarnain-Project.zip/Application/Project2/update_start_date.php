...
if (isset($_POST['field_submit'])) {
    ...
    $var_start_date= $_POST['field_start_date'];
    // Save the query into variable called $query. Note that :director is a place holder
    $query= "UPDATE Mega_Table SET employment_start_date=:start_date WHERE case_number=:applicant;" 
    ."Call update_start_date(:applicant,:start_date)";
...
try
    {
      ...
      $prepared_stmt->bindValue(':start_date', $var_start_date, PDO::PARAM_STR);
...
<!-- Everything inside the BODY tags are visible on page.-->
  <body>
    ...
    <h1> Update Applicant's Employment Start Date</h1>
    ...
    <form method="post">
      ...
      <label for="id_start_date">New Employment Start Date</label>
      <input type="text" name="field_start_date" id = "id_start_date">
    ...
    ?>
          Employment Start Date  was updated successfully. 
    <?php 
        } else { 
    ?>
